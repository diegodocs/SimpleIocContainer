namespace SimpleIoCContainer.Contracts
{
    ...
    public class RegisteredObject(Type contractType, Type implementationType, object? instance = null, ObjectLifeCycle lifeCycle = ObjectLifeCycle.Transient)
    {
        ...
        public ObjectLifeCycle LifeCycle { get; protected set; } = lifeCycle;
